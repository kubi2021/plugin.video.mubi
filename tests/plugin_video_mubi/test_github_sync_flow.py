...
class TestGithubSyncFlow:
    ...
    def test_github_sync_skips_provider_check(self, mock_log, mock_dialog_cls, mock_factory, navigation_handler):
        ...
        # Should have proceeded to start sync ("Starting sync: Syncing from GitHub...")
        assert any("Starting sync: Syncing from GitHub..." in str(call) for call in mock_log.call_args_list)
