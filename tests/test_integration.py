...
class TestRealComponentIntegration:
    ...
    def real_film_library(self):
        """Create a real Film_Library instance."""
        return Film_Library()

    @pytest.fixture
    def sample_film_metadata(self):
        """Create real FilmMetadata instance."""
        return FilmMetadata(
    ...
    def test_film_library_add_and_retrieve(self, real_film_library, sample_film):
    ...
    def test_film_folder_name_sanitization(self, sample_film):
        """Test that film folder names are properly sanitized."""
        # Test with problematic characters
        sample_film.title = "Test/Movie: With*Bad?Characters"
        sample_film.metadata.year = 2023

        folder_name = sample_film.get_sanitized_folder_name()

        # Should replace problematic characters with spaces
    ...
    def test_library_file_operations_integration(self, real_film_library, sample_film):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch.object(sample_film, 'create_nfo_file') as mock_nfo, \
                ...
                expected_folder = plugin_userdata_path / "films" / sample_film.get_sanitized_folder_name()
    ...
    def test_obsolete_file_removal_integration(self, real_film_library, sample_film):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # Create some obsolete folders
            obsolete1 = films_dir / "Old Movie (2020)"
            obsolete2 = films_dir / "Another Old Movie (2021)"
            obsolete1.mkdir()
            obsolete2.mkdir()
            ...
            # Create current film folder
            current_folder = films_dir / sample_film.get_sanitized_folder_name()
    ...
    def test_mubi_initialization_with_real_session(self, real_session_manager):
        ...
        assert len(mubi.film_library) == 0
...
class TestWorkflowIntegration:
    ...
    def test_first_run_workflow(self, workflow_setup):
        ...
        # Simulate first run
        setup['addon'].getSetting.return_value = 'false'  # first_run_completed = false
